...
```{block2, type='bdd'}
Suite à la lecture de l’ACP, réalisez ce projet individuel pour appliquer vos nouvelles connaissances.
...
```{block2, type='bdd'}
Suite à la lecture de l’AFC, completez ce projet individuel pour appliquer vos nouvelles connaissances.
