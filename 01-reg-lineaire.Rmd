...
* Pour les autres utilisateurs de ce livre, veuillez faire un "fork" du dépôt [eucalyptus
](https://github.com/BioDataScience-Course/eucalyptus). Si vous souhaitez accéder à une version précédente particulière de l'exercice, sélectionnez la release correspondante à l'année que vous recherchez.  
