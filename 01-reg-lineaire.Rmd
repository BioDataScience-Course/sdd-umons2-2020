...
`r learnr("B01a_rappel", title = "Rappel de SDD I", toc = "Tutoriel pour réviser les notions de SDD I")`
...
`r launch_shiny("https://sdd.umons.ac.be/B01a_reglin/", height = 500, delay = 20, toc = "Ajuster la meilleure droite")`
...
`r learnr("B01b_reg_lin", title = "Régression linéaire simple", toc = "Tutoriel sur la régression linéaire simple.")`
