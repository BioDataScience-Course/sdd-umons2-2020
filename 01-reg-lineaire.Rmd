...
`r launch_shiny("https://sdd.umons.ac.be/B01_reglin/", height = 600)`
...
```{block, type = 'bdd'}
Maintenant que vous avez appréhendé les différents notions de ce module 1, réalisez les exercices dans l'assignation suivante. Ce projet est spécifique et uniquement dédié au module 1. Ce dernier doit être terminé à la fin de ce module
...
> Cours de Sciences des données II à Mons : <...>
...
> Veuillez faire un "fork" du dépôt [sdd2_module01](https://github.com/BioDataScience-Course/sdd2_module01). Si vous souhaitez accéder à une version précédente de l'exercice, sélectionner la release correspondante à l'année que vous recherchez.  
