...
`r learnr("B06La_kmeans", title = "Regroupement via les k-moyennes", toc = "Regroupement via les k-moyennes")`
...
`r learnr("B06Lb_mds", title = "Ordination via le partionnement multidimensionnel", toc = "Ordination via le partionnement multidimensionnel")`

Complétez votre assignation grâce à vos nouvelles connaissances.
...
<!-- TODO: rewrite this with the new functions, including the two next chunks ! -->
...
Les V1 à V49 sont les numéros de cellules. Nous pouvons couper à différents endroits dans ce dendrogramme, mais si nous décidons de distinguer les cinq groupes correspondants au niveau de coupure à une hauteur de 11,5 (comme sur le graphique), voici ce que cela donne\ :
