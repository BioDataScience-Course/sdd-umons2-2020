...
assignation("B02Ga_anscombe", part = NULL,
  url = "https://github.com/BioDataScience-Course/anscombe",
  course.urls = c(
    'S-BIOG-015' = "https://classroom.github.com/a/...", 
    'S-BIOG-937' = "https://classroom.github.com/a/3EMyegs8"),
  toc = "Assignation : Régression linéaire simple sur le quartet d’Anscombe.")
```
...
`r learnr("B02La_reg_multi", title = "Régression linéaire multiple", toc = "Tutoriel sur la régression linéaire multiple.")`
...
`r learnr("B02Lb_reg_poly", title = "Régression linéaire polynomiale", toc = "Tutoriel sur la régression linéaire polynomiale.")`

- Réalisez un carnet de laboratoire sur la biométrie des oursins avec l'assignation ci-dessous.

```{r, echo=FALSE, results='asis'}
assignation("B02Gb_urchin", part = NULL,
  url = "https://github.com/BioDataScience-Course/urchin",
  course.urls = c(
    'S-BIOG-015' = "https://classroom.github.com/a/...", 
    'S-BIOG-937' = "https://classroom.github.com/a/..."),
  toc = "Assignation : Urchin - Exercices pratiques sur la régression linéaire.")
```

- Réalisez un rapport scientifique sur la croissance des escargots géants d'Afrique.

```{r, echo=FALSE, results='asis'}
assignation("B02Gc_achatina", part = NULL,
  url = "https://github.com/BioDataScience-Course/achatina",
  course.urls = c(
    'S-BIOG-015' = "https://classroom.github.com/a/...", 
    'S-BIOG-937' = "https://classroom.github.com/a/jGUT4KnU"),
  toc = "Assignation : Achatina - Exercices pratiques sur la régression linéaire.")
```
