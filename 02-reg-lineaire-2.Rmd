...
assignation("B02Ga_anscombe", part = NULL,
  ...
  course.urls = c(
    ...
    'S-BIOG-937' = "https://classroom.github.com/a/9EQCVg1n"),
...
assignation("B02Gb_achatina", part = NULL,
  ...
  toc = "Achatina - Exercices pratiques sur la régression linéaire.")
```

- Réalisez en binôme un carnet de laboratoire et un rapport sur la biométrie des oursins avec l'assignation ci-dessous.

```{r, echo=FALSE, results='asis'}
assignation("B02Gc_urchin", part = NULL,
  url = "https://github.com/BioDataScience-Course/B02G_urchin",
  course.urls = c(
    'S-BIOG-015' = "https://classroom.github.com/a/OCKDjX4n", 
    'S-BIOG-937' = "https://classroom.github.com/g/5nzpamBh"),
