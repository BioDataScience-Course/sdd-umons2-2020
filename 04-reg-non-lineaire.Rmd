...
`r launch_shiny("https://sdd.umons.ac.be/B04Sa_micmen/", height = 600, delay = 20, toc = "Ajuster la meilleur courbe de Michaelis-Menten")`
...
assignation("B04Ga_speed_reaction", part = NULL,
  url = "https://github.com/BioDataScience-Course/B04Ga_speed_reaction",
  course.urls = c(
...
`r learnr("B04La_nls", title = "Modèles non-linéaires", toc = "Tutoriel sur les modèles non linéaires.")`
